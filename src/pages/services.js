...
return (
	...
	<p className="pageParagraph">Web Design</p>
	<p className="pageParagraph">We create websites on either WordPress or React. We can create anything from small business websites to large eCommerce websites with either platform. Which one we create your website on is completely up to you.
