...
return (
	...
	<p>Typical WordPress Design Cost Range: $1,500 - $5,000.
	...
	<p>Typical React Website Design Cost Range: $10,000 - $100,000.
	<br/><em className="subFont">*Prices vary depending on the size of the project.</em></p>

	<hr className="beyondMain"/>

	<h2 id="WebManagement">Website Management</h2>
	...
	<h2 id="SmallProject">Smaller Projects</h2>
